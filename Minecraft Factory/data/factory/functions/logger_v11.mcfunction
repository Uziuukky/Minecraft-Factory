...
execute as @e[tag=loggerFAF] at @s anchored eyes positioned ~ ~ ~ if entity @a[tag=playF,distance=0..1.11,tag=loggerGFF] run playsound minecraft:block.wool.place master @a[tag=playF] ~ ~ ~ 100 0 1
