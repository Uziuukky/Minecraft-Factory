...
execute as @e[tag=shopAF] at @s if entity @e[tag=itemTF,type=item,nbt={Item:{id:"minecraft:oak_log"}},distance=0..5] store result score @e[tag=shopCSTF,limit=1,sort=nearest] shopBAF run data get entity @e[tag=itemTF,type=item,nbt={Item:{id:"minecraft:oak_log"}},distance=0..5,limit=1,sort=nearest] Item.Count
execute as @e[tag=shopAF] at @s if entity @e[tag=itemTF,type=item,nbt={Item:{id:"minecraft:oak_log"}},distance=0..5] run particle minecraft:block oak_log ~ ~ ~ 0.2 0.2 0.2 0 10 force @a
execute as @e[tag=shopAF] at @s if entity @e[tag=itemTF,type=item,nbt={Item:{id:"minecraft:oak_log"}},distance=0..5] run playsound minecraft:block.wood.break master @a[tag=playF] ~ ~ ~ 100 1 1
execute as @e[tag=itemTF,nbt={Item:{id:"minecraft:oak_log"}},type=item] at @s if entity @e[tag=shopAF,distance=0..5] run kill @s
...
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ~3 ~1 ~3 ~-3 ~1 ~-3 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ~3 ~ ~3 ~-3 ~ ~-3 oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^1 ^ ^3 ^-1 ^ ^-2 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^2 ^ ^2 ^-2 ^ ^0 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^2 ^ ^-2 ^-2 ^ ^-2 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^3 ^1 ^1 ^3 ^1 ^-1 oak_fence
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^-3 ^1 ^-3 ^-3 ^1 ^-2 oak_fence
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run fill ^-3 ^1 ^ ^-3 ^1 ^-1 oak_planks
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run setblock ^-3 ^2 ^-1 oak_slab[type=bottom]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run playsound minecraft:entity.villager.work_mason master @a[tag=playF] ~ ~ ~ 100 0.5 1
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0},sort=nearest,limit=1,distance=0..3] run particle minecraft:falling_dust birch_planks ~ ~ ~ 2 0 2 0 100 force @a
execute as @e[tag=shopCSTF,scores={shopBF=60..,shopBLF=0}] at @s run scoreboard players set @s shopBLF 1

execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ~3 ~1 ~3 ~-3 ~1 ~-3 oak_fence
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ~2 ~1 ~2 ~-2 ~1 ~-2 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ^1 ^ ^3 ^1 ^2 ^3 stripped_oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ^-1 ^ ^3 ^-1 ^2 ^3 stripped_oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run setblock ^ ^1 ^3 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ^3 ^2 ^3 ^2 ^2 ^-1 oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ^-3 ^2 ^3 ^-2 ^2 ^-1 oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run fill ^2 ^2 ^2 ^-2 ^2 ^-1 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run playsound minecraft:entity.villager.work_mason master @a[tag=playF] ~ ~ ~ 100 0.5 1
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1},sort=nearest,limit=1,distance=0..3] run particle minecraft:falling_dust birch_planks ~ ~ ~ 2 0 2 0 100 force @a
execute as @e[tag=shopCSTF,scores={shopBF=120..,shopBLF=1}] at @s run scoreboard players set @s shopBLF 2

execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run setblock ^ ^2 ^3 stripped_oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^2 ^ ^-1 ^2 ^2 ^-1 oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^-2 ^ ^-1 ^-2 ^2 ^-1 oak_wood[axis=y]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^ ^ ^-1 ^-1 ^ ^-1 oak_slab[type=top]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^1 ^2 ^-1 ^-1 ^2 ^-1 oak_slab[type=top]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^3 ^2 ^-3 ^-3 ^2 ^-2 oak_planks
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run fill ^-2 ^2 ^-2 ^2 ^2 ^-2 air
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run playsound minecraft:entity.villager.work_mason master @a[tag=playF] ~ ~ ~ 100 0.5 1
execute as @e[tag=shopAF,tag=shopEAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run setblock ^1 ^ ^-1 oak_fence_gate[open=false,in_wall=false,facing=east]
execute as @e[tag=shopAF,tag=shopWAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run setblock ^1 ^ ^-1 oak_fence_gate[open=false,in_wall=false,facing=west]
execute as @e[tag=shopAF,tag=shopNAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run setblock ^1 ^ ^-1 oak_fence_gate[open=false,in_wall=false,facing=north]
execute as @e[tag=shopAF,tag=shopSAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run setblock ^1 ^ ^-1 oak_fence_gate[open=false,in_wall=false,facing=south]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2},sort=nearest,limit=1,distance=0..3] run particle minecraft:falling_dust birch_planks ~ ~ ~ 2 0 2 0 100 force @a
execute as @e[tag=shopCSTF,scores={shopBF=180..,shopBLF=2}] at @s run scoreboard players set @s shopBLF 3

execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run setblock ^ ^1 ^-3 obsidian
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run fill ^2 ^3 ^2 ^-2 ^3 ^-3 spruce_slab[type=bottom]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run fill ^1 ^3 ^3 ^-1 ^3 ^3 spruce_slab[type=bottom]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run fill ^3 ^3 ^-1 ^-3 ^3 ^-2 spruce_slab[type=bottom]
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run fill ^2 ^3 ^-2 ^-2 ^3 ^-2 spruce_planks
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run fill ^ ^3 ^2 ^ ^3 ^-2 spruce_planks
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run particle minecraft:falling_dust birch_planks ~ ~ ~ 2 0 2 0 100 force @a
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s run playsound minecraft:block.anvil.use master @a[tag=playF] ~ ~ ~ 100 0.1 1
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s if entity @e[tag=shopWAF,distance=0..3] align xyz run summon armor_stand ~0.5 ~1 ~0.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["shopVSF","shopWVSF"]}
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s if entity @e[tag=shopNAF,distance=0..3] align xyz run summon armor_stand ~0.5 ~1 ~0.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["shopVSF","shopNVSF"]}
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s if entity @e[tag=shopEAF,distance=0..3] align xyz run summon armor_stand ~0.5 ~1 ~0.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["shopVSF","shopEVSF"]}
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s if entity @e[tag=shopSAF,distance=0..3] align xyz run summon armor_stand ~0.5 ~1 ~0.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["shopVSF","shopSVSF"]}
...
execute as @e[tag=shopAF] at @s if entity @e[tag=shopCSTF,scores={shopBF=250..},sort=nearest,limit=1,distance=0..3] run summon item ~ ~ ~ {Tags:["logSIF"],PickupDelay:0,Item:{id:"minecraft:oak_log",Count:1b,tag:{display:{Name:'{"text":"나무 원목","color":"#946012","bold":true,"italic":false}'},Log:1b}}}
...
execute as @e[tag=shopCSTF,scores={shopBF=250..}] at @s run kill @e[tag=shopAF,distance=0..3]
...
execute as @e[tag=shopVSF,sort=random,limit=1] at @s if entity @e[tag=shopperCMF,distance=0.1..] if entity @a[tag=playF,scores={shopVTF=1..}] unless entity @e[tag=shopTF] unless entity @e[type=villager,distance=0..0.5] run summon minecraft:armor_stand ~ ~-1 ~ {Tags:["shopTF"],Invisible:1b,NoGravity:1b,CustomNameVisible:1b}
execute as @e[tag=shopperCMF] at @s if entity @a[tag=playF,scores={shopVTF=1..}] unless entity @e[tag=shopDF] if entity @e[tag=shopTF] unless entity @e[type=villager,distance=0..0.5] run summon minecraft:armor_stand ~ ~ ~ {Tags:["shopDF"],Invisible:1b,NoGravity:1b,CustomNameVisible:0b}
...
execute as @a[tag=playF,scores={shopVTF=1..}] at @s if entity @e[tag=shopTF] unless entity @e[tag=shopDF] run scoreboard players set @s shopVTF 0
