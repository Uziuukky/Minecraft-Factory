...
execute as @a[tag=playF,nbt={OnGround:1b},tag=!wooden.pickaxe.frameRF] at @s if block ~ ~-0.001 ~ minecraft:crafting_table if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 곡괭이 틀]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
...
execute as @a[tag=playF,nbt={OnGround:1b},tag=!stone.pickaxeRF] at @s if block ~ ~-0.001 ~ minecraft:crafting_table if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[돌 곡괭이]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=blast.furnaceRF] at @s if block ~ ~-0.001 ~ minecraft:crafting_table if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[용광로]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"돌 조각 x20","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add blast.furnaceRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!blast.furnaceRF] at @s if block ~ ~-0.001 ~ minecraft:crafting_table if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[용광로]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
