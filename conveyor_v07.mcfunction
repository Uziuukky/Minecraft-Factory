...
execute as @e[tag=arrowF,scores={rotationIF=1},tag=stopCF] at @s if block ~-1 ~-1 ~ minecraft:scaffolding positioned ~-1 ~ ~ if entity @e[tag=craftingAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=stopCF] at @s if block ~ ~-1 ~-1 minecraft:scaffolding positioned ~ ~ ~-1 if entity @e[tag=craftingAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=stopCF] at @s if block ~1 ~-1 ~ minecraft:scaffolding positioned ~1 ~ ~ if entity @e[tag=craftingAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=stopCF] at @s if block ~ ~-1 ~1 minecraft:scaffolding positioned ~ ~ ~1 if entity @e[tag=craftingAF,distance=0..0.05] run tag @s remove stopCF

execute as @e[tag=arrowF,scores={rotationIF=1},tag=stopCF] at @s if block ~-1 ~-1 ~ minecraft:scaffolding positioned ~-1 ~ ~ if entity @e[tag=furnaceCAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=stopCF] at @s if block ~ ~-1 ~-1 minecraft:scaffolding positioned ~ ~ ~-1 if entity @e[tag=furnaceCAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=stopCF] at @s if block ~1 ~-1 ~ minecraft:scaffolding positioned ~1 ~ ~ if entity @e[tag=furnaceCAF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=stopCF] at @s if block ~ ~-1 ~1 minecraft:scaffolding positioned ~ ~ ~1 if entity @e[tag=furnaceCAF,distance=0..0.05] run tag @s remove stopCF
