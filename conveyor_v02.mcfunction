...
execute as @e[tag=itemF,tag=!stopMF] at @s if entity @e[tag=arrowF,tag=stopCF,distance=0..0.05] run tag @s add stopMF
execute as @e[tag=itemF,tag=stopMF] at @s unless entity @e[tag=arrowF,tag=stopCF,distance=0..0.05] run tag @s remove stopMF

execute as @e[tag=arrowF,scores={rotationIF=1},tag=!stopCF] at @s if block ~-1 ~-1 ~ air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @e[tag=itemF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=!stopCF] at @s if block ~ ~-1 ~-1 air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @e[tag=itemF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=!stopCF] at @s if block ~1 ~-1 ~ air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @e[tag=itemF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=!stopCF] at @s if block ~ ~-1 ~1 air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @e[tag=itemF,distance=0..0.05] add stopMF

execute as @e[tag=arrowF,scores={rotationIF=1},tag=!stopCF] at @s if block ~-1 ~-1 ~ air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=!stopCF] at @s if block ~ ~-1 ~-1 air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=!stopCF] at @s if block ~1 ~-1 ~ air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=!stopCF] at @s if block ~ ~-1 ~1 air positioned ~ ~ ~ if entity @e[tag=itemF,distance=0..0.05] run tag @s add stopCF

execute as @e[tag=arrowF,scores={rotationIF=1},tag=stopCF] at @s if block ~-1 ~-1 ~ smooth_stone_slab positioned ~-1 ~ ~ if entity @e[tag=!stopCF,tag=arrowF,distance=0..0.05] positioned ~1 ~ ~ unless entity @e[tag=stopMF,tag=itemF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=stopCF] at @s if block ~ ~-1 ~-1 smooth_stone_slab positioned ~ ~ ~-1 if entity @e[tag=!stopCF,tag=arrowF,distance=0..0.05] positioned ~ ~ ~1 unless entity @e[tag=stopMF,tag=itemF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=stopCF] at @s if block ~1 ~-1 ~ smooth_stone_slab positioned ~1 ~ ~ if entity @e[tag=!stopCF,tag=arrowF,distance=0..0.05] positioned ~-1 ~ ~ unless entity @e[tag=stopMF,tag=itemF,distance=0..0.05] run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=stopCF] at @s if block ~ ~-1 ~1 smooth_stone_slab positioned ~ ~ ~1 if entity @e[tag=!stopCF,tag=arrowF,distance=0..0.05] positioned ~ ~ ~-1 unless entity @e[tag=stopMF,tag=itemF,distance=0..0.05] run tag @s remove stopCF
...
execute as @e[tag=arrowF,scores={rotationIF=1},tag=!stopCF] at @s positioned ~-1 ~ ~ if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] positioned ~1 ~ ~ run tag @e[tag=itemF,tag=!stopMF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=!stopCF] at @s positioned ~ ~ ~-1 if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] positioned ~ ~ ~1 run tag @e[tag=itemF,tag=!stopMF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=!stopCF] at @s positioned ~1 ~ ~ if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] positioned ~-1 ~ ~ run tag @e[tag=itemF,tag=!stopMF,distance=0..0.05] add stopMF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=!stopCF] at @s positioned ~ ~ ~1 if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] positioned ~ ~ ~-1 run tag @e[tag=itemF,tag=!stopMF,distance=0..0.05] add stopMF

execute as @e[tag=arrowF,scores={rotationIF=1},tag=!stopCF] at @s positioned ~-1 ~ ~ if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=2},tag=!stopCF] at @s positioned ~ ~ ~-1 if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=3},tag=!stopCF] at @s positioned ~1 ~ ~ if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] run tag @s add stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=!stopCF] at @s positioned ~ ~ ~1 if entity @e[tag=stopCF,tag=arrowF,distance=0..0.05] if entity @e[tag=itemF,tag=stopMF,distance=0..0.05] run tag @s add stopCF
...
execute as @e[tag=arrowF,scores={rotationIF=3},tag=stopCF] at @s if block ~1 ~-1 ~ minecraft:scaffolding if block ~1 ~ ~ minecraft:crafting_table run tag @s remove stopCF
execute as @e[tag=arrowF,scores={rotationIF=4},tag=stopCF] at @s if block ~ ~-1 ~1 minecraft:scaffolding if block ~ ~ ~1 minecraft:crafting_table run tag @s remove stopCF
