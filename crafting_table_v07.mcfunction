...
kill @e[tag=craftingFF]

execute as @e[tag=craftingAF] at @s align xyz run summon falling_block ~0.5 ~ ~0.5 {BlockState:{Name:"minecraft:crafting_table"},NoGravity:1b,HasVisualFire:0b,Time:1,Tags:["craftingFF"]}
...
execute as @a[tag=playF,nbt={Inventory:[{id:"minecraft:crafting_table",Slot:-106b,tag:{Crafting:1b}}]},tag=completeCTF] at @s anchored eyes positioned ^ ^ ^3 if block ~ ~ ~ air unless block ~ ~-1 ~ air run setblock ~ ~ ~ barrier
execute as @a[tag=playF,nbt={Inventory:[{id:"minecraft:crafting_table",Slot:-106b,tag:{Crafting:1b}}]},tag=completeCTF] at @s anchored eyes positioned ^ ^ ^3 if block ~ ~ ~ minecraft:barrier unless block ~ ~-1 ~ air run clear @s minecraft:crafting_table{Crafting:1b} 1
execute as @a[tag=playF,nbt={Inventory:[{id:"minecraft:crafting_table",Slot:-106b,tag:{Crafting:1b}}]},tag=completeCTF] at @s anchored eyes positioned ^ ^ ^3 if block ~ ~ ~ minecraft:barrier unless block ~ ~-1 ~ air run tag @s remove completeCTF
...
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
execute as @a[tag=playF,nbt={OnGround:1b},tag=planksRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 판자]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"나무 원목 x1","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add planksRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!planksRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 판자]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=stickRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 막대기]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"나무 판자 x2","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add stickRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!stickRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 막대기]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=wooden.pickaxeRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 곡괭이]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"나무 판자 x3 , 나무 막대기 x2","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add wooden.pickaxeRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!wooden.pickaxeRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 곡괭이]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=wooden.pickaxe.frameRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 곡괭이 틀]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"나무 곡괭이 x1 , 나무 판자 x1","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add wooden.pickaxe.frameRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!wooden.pickaxe.frameRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[나무 곡괭이 틀]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=stone.pickaxeRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[돌 곡괭이]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"나무 곡괭이 틀 x1 , 나무 막대기 x2 , 돌 조각 x3","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/tag @s add stone.pickaxeRCF"}}]
execute as @a[tag=playF,nbt={OnGround:1b},tag=!stone.pickaxeRF] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingIF,distance=0..1.5] run tellraw @s [{"text":"[돌 곡괭이]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"레시피 없음","color":"dark_red"}]}}]
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingPIF,distance=0..1.5] run tellraw @s [{"text":"\n제조 아이템 : ","color":"gold","bold":true,"italic":false},{"text":"[ 나무 판자 ]","color":"white","bold":true,"italic":false}]
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingSIF,distance=0..1.5] run tellraw @s [{"text":"\n제조 아이템 : ","color":"gold","bold":true,"italic":false},{"text":"[ 나무 막대기 ]","color":"white","bold":true,"italic":false}]
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingWPIF,distance=0..1.5] run tellraw @s [{"text":"\n제조 아이템 : ","color":"gold","bold":true,"italic":false},{"text":"[ 나무 곡괭이 ]","color":"white","bold":true,"italic":false}]
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingWPFIF,distance=0..1.5] run tellraw @s [{"text":"\n제조 아이템 : ","color":"gold","bold":true,"italic":false},{"text":"[ 나무 곡괭이 틀 ]","color":"white","bold":true,"italic":false}]
execute as @a[tag=playF,nbt={OnGround:1b}] at @s if block ~ ~-0.001 ~ minecraft:barrier if entity @e[tag=craftingSPIF,distance=0..1.5] run tellraw @s [{"text":"\n제조 아이템 : ","color":"gold","bold":true,"italic":false},{"text":"[ 돌 곡괭이 ]","color":"white","bold":true,"italic":false}]
